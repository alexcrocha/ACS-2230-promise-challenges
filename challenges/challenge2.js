 ...
 *
 * A: First it will print "Hello there, Ducky" and after "Make School is Awesome!!!"
 ...
 *
 * A: uppercaser() doesn't run anymore. Because the promise fails and is rejected,
 *    the .catch() method is triggered instead, and the error is displayed.
 *
 ...
 *    run the code again.
 *
 * A: greet() runs and is resolved, and uppercaser() runs but gets rejected. The
 *    catch() method is triggered with uppercaser() rejection message this time.
 *
...
const name = "Roadhog";
const my_str = '"It\'s hogging time"';
const str = "VIOLENCE";
